...
| `bipad-api` | Disasters / hydrology | NDRRMA BIPAD | `https://bipadportal.gov.np/api/v1/` (hazard, incident, alert, river-stations) | 1–5 min | None (public JSON) | Government DRM portal; polite rate limits; filter `hazard.type=natural` | Live |
| `usgs-eq` | Earthquakes | USGS | FDSN Event API + GeoJSON feeds | 30–60s | None | Public domain USGS | Live |
